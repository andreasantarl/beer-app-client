...
/***/ function(module, exports, __webpack_require__) {
	...
	var drake = __webpack_require__(55);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayAllUserBeersTemplate = __webpack_require__(39);

	var drake = __webpack_require__(40);
	...
	var onDisplayOneBeerInfo = function onDisplayOneBeerInfo(event) {
	  event.preventDefault();
	  var id = $(event.target).attr('data-id');
	  api.showOneBeer(id) //send buttonID for get request
	  .then(ui.showThisBeerInfoSuccess).catch(function (error) {
	    return console.error(error);
	  });
	};

	var onSortMyBeers = function onSortMyBeers(event) {
	  event.preventDefault();
	...
	var onSortTheirBeers = function onSortTheirBeers(event) {
	  event.preventDefault();
	  var element = document.getElementById("sort-by");
	  var sort = element.options[element.selectedIndex].value;
	...
	var bubbleSort = function bubbleSort(data, sort) {
	  ...
	  if (sort === "beer_name") {
	    ...
	    for (var _i = 0; _i < beers.length; _i++) {
	      for (var _j = 0; _j < beers.length - _i - 1; _j++) {
	        if (beers[_j].company_name.toUpperCase() > beers[_j + 1].company_name.toUpperCase()) {
	          tmp = beers[_j];
	          beers[_j] = beers[_j + 1];
	          beers[_j + 1] = tmp;
	        }
	    ...
	    for (var _i2 = 0; _i2 < beers.length; _i2++) {
	      for (var _j2 = 0; _j2 < beers.length - _i2 - 1; _j2++) {
	        if (beers[_j2].beer_style.toUpperCase() > beers[_j2 + 1].beer_style.toUpperCase()) {
	          tmp = beers[_j2];
	          beers[_j2] = beers[_j2 + 1];
	          beers[_j2 + 1] = tmp;
	        }
	      }
	    }
	  } else if (sort === "abv") {
	    for (var _i3 = 0; _i3 < beers.length; _i3++) {
	      for (var _j3 = 0; _j3 < beers.length - _i3 - 1; _j3++) {
	        if (parseFloat(beers[_j3].abv) > parseFloat(beers[_j3 + 1].abv)) {
	          tmp = beers[_j3];
	          beers[_j3] = beers[_j3 + 1];
	          beers[_j3 + 1] = tmp;
	        }
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <li>\n  <div class=\"contents col-md-3 well col-md-push-1\">\n   <h4>"
	    ...
	    + "</h4>\n     <img src=\""
	    + alias4(((helper = (helper = helpers.photo || (depth0 != null ? depth0.photo : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"photo","hash":{},"data":data}) : helper)))
	    + "\" height=\"190px\" class=\"beerImage myBeers\" data-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	  ...
	  return "<div class=\"sort-display-section\">\n  <form>\n    <fieldset class=\"form-group\">\n      <select id=\"sort-by\">\n        <option value=\"\">...</option>\n        <option value=\"beer_name\">Beer name</option>\n        <option value=\"company_name\">Brewer</option>\n        <option value=\"beer_style\">Style</option>\n        <option value=\"abv\">ABV</option>\n      </select>\n      <button type=\"submit\" class=\"sort-display btn btn-md\">Sort me</button>\n    </fieldset>\n  </form>\n</div>\n\n\n<h2>{ Mine }</h2>\n<ul class='draggable'>\n\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <li>\n    <div class=\"contents col-md-3 well col-md-push-1\">\n      <h4>"
	    ...
	    + alias4(((helper = (helper = helpers.beer_name || (depth0 != null ? depth0.beer_name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"beer_name","hash":{},"data":data}) : helper)))
	    + "\"/>\n          <input class=\"form-control hidden\" type=\"text\" name=beers[company_name] value=\""
	    + alias4(((helper = (helper = helpers.company_name || (depth0 != null ? depth0.company_name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"company_name","hash":{},"data":data}) : helper)))
	    + "\"/>\n          <input class=\"form-control hidden\" type=\"text\" name=beers[beer_style] value=\""
	    + alias4(((helper = (helper = helpers.beer_style || (depth0 != null ? depth0.beer_style : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"beer_style","hash":{},"data":data}) : helper)))
	    + "\"/>\n          <input class=\"form-control hidden\" type=\"text\" name=beers[abv] value=\""
	    + alias4(((helper = (helper = helpers.abv || (depth0 != null ? depth0.abv : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"abv","hash":{},"data":data}) : helper)))
	  ...
	  return "<div class=\"sort-display-section\">\n  <form>\n    <fieldset class=\"form-group\">\n      <select id=\"sort-by\">\n        <option value=\"\">...</option>\n        <option value=\"beer_name\">Beer name</option>\n        <option value=\"company_name\">Brewer</option>\n        <option value=\"beer_style\">Style</option>\n        <option value=\"abv\">ABV</option>\n      </select>\n      <button type=\"submit\" class=\"sort-display-everyone btn btn-md\">Sort me</button>\n    </fieldset>\n  </form>\n</div>\n\n<h2>{ Theirs }</h2>\n\n<ul class='draggable'>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.beers : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</ul>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ticky = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var beersTemplate = __webpack_require__(53);
	var displayAllUserBeersTemplate = __webpack_require__(39);
	var oneBeerTemplate = __webpack_require__(54);
	...
	module.exports = {
	  ...
	  showThisBeerInfoSuccess: showThisBeerInfoSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
	  var dragula = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jQuery-ui"] = __webpack_require__(71);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	( function( factory ) {
		if ( true ) {
			...
			!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(2), __webpack_require__(72) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
		} else {
